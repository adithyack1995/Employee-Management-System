...
INSERT INTO `employees` (`id`, `name`, `emp_code`, `department`, `dob`, `joining_date`, `created_at`) VALUES
(19, 'Adithya ck', 'EMP123', 'Software', '2000-01-01', '2019-01-30', '2021-06-08 13:17:23');
...
(1, 'admin', '$2y$10$4OjgXyQY0UGKESMujlH2n.gkXlo.eIhjkgMnGth5T0JYrvhWB9JgC', 'admin@admin.com', 'test', 'test', '80789998', 2, 1),
(3, 'user1', '$2y$10$LKL.cvxqR1sEgO2L3w1v9uvlC7l9TZWQ1qr48ZW1/7NKd0uNyWm1q', 'user1@user.com', 'user', '1', '', 1, 6);
